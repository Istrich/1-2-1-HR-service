...
## 2026-06-16 - Add ARIA Labels to Panel Search Toolbar
**Learning:** Text-symbol buttons (like "‹" and "›") and search input fields without associated labels are often not adequately described to screen readers, causing accessibility issues.
**Action:** Always include descriptive `aria-label`s for text-symbol buttons and inputs lacking labels to enhance screen reader accessibility.
